...
export const MobileHeader: React.FC<MobileHeaderProps> = ({
  onOpenMenu
    ...
    <button onClick={onOpenMenu} className="w-11 h-11 border border-border inline-flex items-center justify-center hover:bg-bg-hover transition-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70" aria-label="Open menu" title="Open menu">
      <Menu size={24} />
    </button>
  </div>;
