        ...
        setFormula(controlWork?.formula || "");
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="space-y-2">
                  <textarea value={formula} onChange={e => setFormula(e.target.value)} className="w-full px-3 py-2 bg-bg-surface border border-border text-text-primary font-mono text-sm focus:outline-none focus:border-primary min-h-[100px]" placeholder={tr("Наприклад: (test + 1.3 * avg(practice)) / 2", "Example: (test + 1.3 * avg(practice)) / 2")} />
                  <div className="text-xs text-text-secondary space-y-1">
