          ...
          theory: ""
            ...
            <div className="space-y-4">
              ...
              {newTask.type === "PRACTICE" && <div>
                  ...
                  <select value={taskDifficulty} onChange={e => setTaskDifficulty(e.target.value as "1" | "2" | "3" | "4" | "5")} className="w-full px-3 py-2 bg-bg-surface border border-border text-text-primary font-mono focus:outline-none focus:border-primary">
