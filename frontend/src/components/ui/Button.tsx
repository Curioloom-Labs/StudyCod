...
export const Button: React.FC<Props> = ({
  ...
  const base = "inline-flex items-center justify-center font-mono font-medium leading-[1.35] tracking-[0.01em] transition-fast ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-base disabled:opacity-40 disabled:cursor-not-allowed motion-safe:transform-gpu motion-safe:hover:-translate-y-px motion-safe:active:translate-y-0 motion-safe:active:scale-[0.98]";
